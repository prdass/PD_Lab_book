...
2. Crizotinib cytotoxicity assay #1 Day 1

------------------------------------------------------------------
## Task 1: Split cells

H3122 cells were split ([protocol](../Protocols/Splitting_cells.md))<br>
Passage number is now 5<br>
Cells were moved from a large 175m<sup>3 </sup> flask to a medium 75cm<sup>3 </sup> flask

### Next <br>
Change media tomorrow to keep cells happy over the weekend

------------------------------------------------------------------
## Task 2: Crizotinib cytotoxicity Assay 1 Day 1
